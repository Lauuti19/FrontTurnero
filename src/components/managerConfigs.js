// config/tabConfigs.js
export const classesTabConfig = {
...
export const disciplinesTabConfig = {
...
export const exercisesTabConfig = {
...
export const usersTabConfig = {
  title: "Gestion de Usuarios",
  tabs: [
    { id: 'create', label: 'Crear Usuario' },
    { id: 'view', label: 'Actualizar Clave Usuario' }
  ]
};

export const routinesTabConfig = {
